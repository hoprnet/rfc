...
\item
  ...
  ``hop'' and ``relay'' are often used interchangeably {[}01, 02{]}.
...
\item
  ...
  them back out in random order {[}01{]}.
\item
...
{[}01{]} Chaum, D. (1981). {Untraceable Electronic Mail, Return Addresses, and Digital Pseudonyms}.
...
{[}02{]} Danezis, G., \& Goldberg, I. (2009). {Sphinx: A Compact and Provably Secure Mix Format}. \emph{2009 30th IEEE Symposium
on Security and Privacy}, 262-277.
\href{https://cypherpunks.ca/~iang/pubs/Sphinx_Oakland09.pdf}{\underline{https://cypherpunks.ca/~iang/pubs/Sphinx_Oakland09.pdf}}
...
{[}04{]} Reed, M. G., Syverson, P. F., \& Goldschlag, D. M. (1998). {Anonymous Connections and Onion Routing}. \emph{IEEE Journal on Selected Areas in
