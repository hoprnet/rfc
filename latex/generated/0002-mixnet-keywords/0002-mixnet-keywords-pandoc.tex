...
\item
  ...
  another in the mixnet. Relay nodes help to obscure the
  sender\textquotesingle s identity by routing messages through multiple
  nodes {[}01, 02{]}.
\item
  ...
  "relay" are often used interchangeably {[}01, 02{]}. More hops in the
  path generally increase the anonymity of the message, but also
...
\item
  ...
  the context of mixnets, this includes things like the
  sender\textquotesingle s and destination\textquotesingle s IP
  addresses, the size of the message, and the time it was sent or
  received. Mixnets work to shuffle this metadata to protect user
  privacy {[}01, 06{]}.
\item
...
\subsection{4. References}\label{4-references}
