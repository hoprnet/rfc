...
and conventions adopted across the HOPR RFC series. Additionally, this
document defines the following economic system-specific terms:
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[width=\maxwidth,keepaspectratio,alt={Mermaid Diagram 1}]{0007-economic-reward-system/mermaid_1.png}}
