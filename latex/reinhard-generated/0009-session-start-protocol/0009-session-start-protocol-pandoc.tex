...
used throughout this specification. Additionally, this document defines
the following session start protocol-specific terms:
...
\item
  ...
  targets are encoded using CBOR format {[}01{]} to allow flexible
...
\codebubble{"127.0.0.1:1234"},
\codebubble{"wss://relay.example.com:443"} \\
\end{longtable}
...
Message}\label{sessionestablished-message}
...
\subsection{11. Appendix 1}\label{appendix-1}
