...
document are to be interpreted as described in {[}01{]}.
...
\subsubsection{4.1. RFC Life Cycle
Stages}\label{41-rfc-life-cycle-stages}

\paragraph{\texorpdfstring{4.1.1. \textbf{Mermaid Diagram for RFC Life
Cycle
Stages}}{4.1.1. Mermaid Diagram for RFC Life Cycle Stages}}\label{411-mermaid-diagram-for-rfc-life-cycle-stages}

\pandocbounded{\includegraphics[keepaspectratio,width=\maxwidth,alt={Mermaid Diagram 1}]{generated/0001-rfc-process/mermaid_1.png}}

\paragraph{\texorpdfstring{4.1.2. \textbf{Stage
Descriptions:}}{4.1.2. Stage Descriptions:}}\label{412-stage-descriptions}
...
\subsubsection{4.2. File Structure}\label{42-file-structure}
...
\subsubsection{4.3. Validation Rules}\label{43-validation-rules}

\begin{itemize}
\tightlist
\item
  Directory \textbf{MUST} be prefixed with uppercased "RFC", followed by
...
Structure}\label{44-rfc-document-structure}

All RFCs \textbf{MUST} follow a consistent document structure to ensure
readability and maintainability.

\paragraph{4.4.1. Metadata Preface}\label{441-metadata-preface}
...
\paragraph{4.4.2. Reference Styles}\label{442-reference-styles}

RFCs \textbf{MUST} use two distinct reference styles:

\subparagraph{4.4.2.1. RFC-to-RFC
References}\label{4421-rfc-to-rfc-references}

\begin{itemize}
\tightlist
\item
  RFC references to other HOPR RFCs \textbf{MUST} be listed in the
  metadata\textquotesingle s \textbf{Related Links:} field
\item
  Format:
...
\subparagraph{4.4.2.2. External
References}\label{4422-external-references}
...
\item
  ...
  {[}01{]}, {[}02{]}, etc.
\item
  In-text citations \textbf{MUST} use the numbered format: "as described
  in {[}01{]}"
\item
...
\paragraph{4.4.3. Required Sections}\label{443-required-sections}
...
\item
  \textbf{Abstract} - Brief summary of the RFC\textquotesingle s purpose
  and scope
\item
