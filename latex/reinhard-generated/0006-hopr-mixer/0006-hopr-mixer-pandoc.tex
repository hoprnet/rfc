...
\tightlist
\item
\textbf{mixing delay}: A random time interval added to a packet's transit
time through a node to prevent timing correlation attacks.

\textbf{release timestamp}: The calculated time at which a delayed packet
should be forwarded from the mixer.

\textbf{mixing buffer}: A priority queue that holds packets ordered by
...
\subsubsection{5.3. Monitoring and Metrics}\label{monitoring-and-metrics}
...
Danezis, G. (2017). {The Loopix Anonymity System}. \emph{26th USENIX Security Symposium},
1199-1216.
\href{https://arxiv.org/pdf/1703.00536.pdf}{\underline{https://arxiv.org/pdf/1703.00536.pdf}}
